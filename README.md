# nvim-treesitter-queries-kotlin

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-kotlin/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-kotlin/actions/workflows/validate.yml)

Neovim tree-sitter queries for **kotlin**, part of the
...
- [ ] Changes are scoped to `kotlin` — do not include files for other languages
